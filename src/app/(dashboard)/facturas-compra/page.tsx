...
import { getFacturasCompraAction } from "@/features/facturas-compra/actions";
import { FacturasCompraTable } from "@/features/facturas-compra/components";

type FacturasCompraSort = "createdAt" | "factura" | "fecha";
type SortOrder = "asc" | "desc";
type MonthFilterValue = "all" | `${number}`;

interface FacturasCompraPageProps {
...
function parseSort(value?: string): FacturasCompraSort {
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">
                                Consulte y cargue facturas recibidas de
                                proveedores.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                        <div className="flex w-full flex-col gap-3 lg:flex-row lg:items-center">
                            <div className="w-full lg:max-w-md">
                                <SearchInput
                                    basePath="/facturas-compra"
                                    placeholder="Buscar por factura, timbrado, proveedor o documento..."
                                />
                            </div>
