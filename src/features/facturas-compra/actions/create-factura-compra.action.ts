...
export async function createFacturaCompraAction(data: CreateFacturaCompraInput) {
    try {
        ...
        return {
            ...
            message: generarAsientosAutomaticos
                ? "Factura de compra guardada y asiento generado correctamente."
        ...
        if (error instanceof Error) {
            ...
            if (error.message.includes("empresa activa")) {
                return {
                    ...
                    factura: null,
                    message:
                        "Debe seleccionar una empresa activa antes de cargar facturas de compra.",
                };
            }
        }
